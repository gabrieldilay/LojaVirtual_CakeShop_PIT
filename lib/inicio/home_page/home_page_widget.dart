...
import '/componentes/detalhes_produtos/detalhes_produtos_widget.dart';
                              ...
                              children: [
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('tradicionais');
                                    },
                                    child: Card(
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder<List<ProdutosRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ProdutosRow> pesquisaProdutosRowList =
                                    snapshot.data!;
                                return Autocomplete<String>(
                                  ...
                                  optionsBuilder: (textEditingValue) {
                                    ...
                                    return pesquisaProdutosRowList
                                        .map((e) => e.nomeProduto)
                                        .withoutNulls
                                        .toList()
                                        .where((option) {
                                  ...
                                  onSelected: (String selection) {
                                    setState(() => _model
                                        .pesquisaSelectedOption = selection);
                                    FocusScope.of(context).unfocus();
                                  },
                                  fieldViewBuilder: (
                                    context,
                                ...
                                child: CarouselSlider.builder(
                                    ...
                                    return InkWell(
                                      ...
                                      onTap: () async {
                                        await showModalBottomSheet(
                                          ...
                                          barrierColor: const Color(0x7E000000),
                                          enableDrag: false,
                                          context: context,
                                          builder: (context) {
                                            return GestureDetector(
                                              ...
                                              child: Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: DetalhesProdutosWidget(
                                                    titulo: carouselProdutosRow
                                                        .nomeProduto!,
                                                    descricao:
                                                        carouselProdutosRow
                                                            .descricao!,
                                                    imagem: carouselProdutosRow
                                                        .img!,
                                                    valorpromo:
                                                        carouselProdutosRow
                                                            .valorPromo!,
                                  ...
                                  options: CarouselOptions(
                                    initialPage: max(
                                        ...
                                        min(
                                            1,
                                            carouselProdutosRowList.length -
                                                1)),
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Padding(
                                        ...
                                        child: SizedBox(
                                          height: 450.0,
                                          child: DetalhesProdutosWidget(
                                            titulo: listaPratosProdutosRow
                                                .nomeProduto!,
                                            descricao: listaPratosProdutosRow
                                                .descricao!,
                                            imagem: listaPratosProdutosRow.img!,
                                            valorpromo: listaPratosProdutosRow
                                                .valorPromo!,
                                          ),
                                        ),
                                      ),
