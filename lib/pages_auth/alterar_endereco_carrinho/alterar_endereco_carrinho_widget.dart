...
import 'alterar_endereco_carrinho_model.dart';
export 'alterar_endereco_carrinho_model.dart';

class AlterarEnderecoCarrinhoWidget extends StatefulWidget {
  const AlterarEnderecoCarrinhoWidget({super.key});

  @override
  State<AlterarEnderecoCarrinhoWidget> createState() =>
      _AlterarEnderecoCarrinhoWidgetState();
}

class _AlterarEnderecoCarrinhoWidgetState
    extends State<AlterarEnderecoCarrinhoWidget> {
  late AlterarEnderecoCarrinhoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlterarEnderecoCarrinhoModel());
                                ...
                                onPressed: () async {
                                  ...
                                  if ((_model.resultadoAPI?.succeeded ??
                                    ...
                                    FFAppState().enderecoRef = EnderecosStruct(
                                      ...
                                      numero: BuscarCEPCall.complemento(
                                        (_model.resultadoAPI?.jsonBody ?? ''),
                                      ),
