...
import 'editar_produtos_model.dart';
export 'editar_produtos_model.dart';
...
class _EditarProdutosWidgetState extends State<EditarProdutosWidget> {
  ...
  void initState() {
    ...
    _model.tituloTextController ??=
        TextEditingController(text: widget.referencia?.nomeProduto);
    ...
    _model.descricaoTextController ??=
        TextEditingController(text: widget.referencia?.descricao);
                  ...
                  children: [
                    FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController ??=
                        ...
                        _model.dropDownValue ??= widget.referencia?.tag,
                      ),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await ProdutosTable().update(
                          data: {
                            'nome_produto': _model.tituloTextController.text,
