...
import 'caixa_pequena_model.dart';
export 'caixa_pequena_model.dart';

class CaixaPequenaWidget extends StatefulWidget {
  const CaixaPequenaWidget({super.key});

  @override
  State<CaixaPequenaWidget> createState() => _CaixaPequenaWidgetState();
}

class _CaixaPequenaWidgetState extends State<CaixaPequenaWidget> {
  late CaixaPequenaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CaixaPequenaModel());
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  'Sua caixa irá conter 4 Cupcakes do seu sabor escolhido',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '${FFAppState().condicaoGeral.toString()}/1',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Expanded(
                                                                              child: Text(
                                                                                formatNumber(
                                                                                  ((listViewProdutosRow.valor!) * 4) * 0.95,
                          ...
                          if (FFAppState().condicaoGeral == 1) {
                            ...
                            setState(() {
                              FFAppState().addToPedidosCar(PedidosStruct(
                                nomeProduto:
                                    'Caixa Pequena: ${FFAppState().sabores.nomesabor1}',
                                img:
